...
public class FrontMatterRecordValidationTest {
  ...
  private final Actor scActor = new SchemaCrawlerActor().toActor();

  @Test
  public void generatedRecordValidatesActorPrefix() {
    assertThrows(
        NullPointerException.class, () -> new Generated(null, parse("2026-06-25T09:00:00Z")));
    assertDoesNotThrow(() -> new Generated(scActor, parse("2026-06-25T09:00:00Z")));
  }
  ...
  public void verifiedRecordValidatesPresence() {
    ...
    assertDoesNotThrow(() -> new Verified(TrustTier.machine_confirmed, scActor));
  }
  ...
  public void recordsSerializeByAndAtOnly() {
    final Generated generated = new Generated(scActor, parse("2026-06-25T09:00:00Z"));
    final Verified verified = new Verified(TrustTier.machine_confirmed, scActor);
