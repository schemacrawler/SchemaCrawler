...
public class CommandLineScribeHelpTest {
  ...
  public void helpScript(final TestContext testContext, final CapturedSystemStreams streams) {
    final String[] args = {"--help", "command:scribe"};
    ...
    assertThat(
        ...
        hasSameContentAs(classpathResource(COMMANDLINE_HELP_OUTPUT + "help.scribe.stdout.txt")));
  }
}
