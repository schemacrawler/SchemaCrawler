...
[Pre-packaged SchemaCrawler Docker images](https://hub.docker.com/r/schemacrawler/schemacrawler/) are available on Docker Hub. Use the "extra-latest" tag for getting additional commands like the [SchemaCrawler MCP Server](mcpserver.html) and [AI Chat with ChatGPT](aichat.html).
...
Download a file called "schemacrawler-16.26.2-distribution.zip". You should have previously installed the Java SDK on your system. Unzip the file, and
