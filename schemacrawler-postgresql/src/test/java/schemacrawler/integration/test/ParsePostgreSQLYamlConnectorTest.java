...
public class ParsePostgreSQLYamlConnectorTest {
  ...
  @ParameterizedTest
  @ValueSource(strings = {"postgresql"})
  public void parseYamlConnectors(final String server, final CapturedSystemStreams streams)
      throws IOException {
