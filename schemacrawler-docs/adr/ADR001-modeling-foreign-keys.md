...
In previous versions of SchemaCrawler, foreign keys were viewed as maps between two tables. From 16.16.11 onwards, SchemaCrawler views foreign keys more consistently with the SQL standard view.
