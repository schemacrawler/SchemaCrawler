...
/**
 * Allows chaining multiple scCommands with the same configuration. The catalog is obtained just
 * once, and passed on from executable to executable for efficiency in execution.
 */
abstract class BaseCommandChain extends BaseSchemaCrawlerCommand {
  ...
  BaseCommandChain(final String command) throws SchemaCrawlerException {
    super(command);
  ...
  final SchemaCrawlerCommand addNextAndConfigureForExecution(
