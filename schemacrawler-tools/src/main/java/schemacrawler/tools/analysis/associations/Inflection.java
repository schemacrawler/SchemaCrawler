 ...
 * 'http://api.rubyonrails.org/classes/ActiveSupport/CoreExtensions/String/I
 * n f l e c t i o n s . h t m l ' > I n f l e c t i o n s < / a > to
 * handle singularization and pluralization of 'Rails strings'. Copied
 * from <a href='http://code.google.com/p/rogueweb/'>rogueweb</a>'s port
 * of Rails to Java.
 * 
 * @author Anthony Eden
 */
