...
public class LinterTableAllNullableColumns extends BaseLinter {
  ...
  public LinterTableAllNullableColumns() {
    super(
        new PropertyName(
            LinterTableAllNullableColumns.class.getName(),
            LintUtility.readDescription(LinterTableAllNullableColumns.class.getName())));
  }
