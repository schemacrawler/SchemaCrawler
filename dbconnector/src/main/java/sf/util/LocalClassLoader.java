...
/**
 * This classloader can be used to dynamically load classes. The parent
 * class loader will be used first when loading a class. As long as the
 * class for the object being returned is in the parent classloader, the
 * caller will be able to receive the returned object.
 */
  ...
  extends URLClassLoader
{
  ...
  /**
   * Constructor. <p/> Create a new LocalClassLoader given the urls and
   * parent ClassLoader.
   * 
   * @param urls
   *        The url's to use.
  ...
  /**
   * Adds all of the jar and zip archives in the specified directory to
   * the classpath. Only the files ending with .jar and .zip will be
   * used.
   * 
   * @param dirPath
