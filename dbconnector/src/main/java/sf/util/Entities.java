 ...
 * @see </br><a
 *      href="http://www.w3.org/TR/REC-html40/sgml/entities.html">HTML
 ...
 * @since 2.0
 * @version $Id: Entities.java,v 1.1 2005/09/23 23:49:18 sfatehi Exp $
 */
public class Entities
{
    ...
    implements EntityMap
  {
    ...
    private final/* IntHash */Map mapValueToName = new /* Int */HashMap();
  ...
  public String escape(final String str)
  {
    ...
    for (i = 0; i < str.length(); ++i)
    {
      ...
      final String entityName = entityName(ch);
      if (entityName == null)
      {
        if (ch > 0x7F)
        {
