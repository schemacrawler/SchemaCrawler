...
CREATE TABLE ITEM(INVOICEID INTEGER NOT NULL,ITEM INTEGER NOT NULL,PRODUCTID INTEGER,QUANTITY INTEGER,COST DECIMAL,PRIMARY KEY(INVOICEID,ITEM));
...
CREATE TABLE INVOICE(ID INTEGER NOT NULL PRIMARY KEY,CUSTOMERID INTEGER,TOTAL DECIMAL,CONSTRAINT SYS_FK_1 FOREIGN KEY(CUSTOMERID) REFERENCES CUSTOMER(ID));
CREATE TABLE SUPPLIER(SUPPLIER_ID INTEGER,SUPPLIER_NAME VARCHAR(50),CONSTRAINT CHECK_UPPERCASE_SUPPLIER_NAME CHECK(SUPPLIER.SUPPLIER_NAME=UPPER(SUPPLIER.SUPPLIER_NAME)));
