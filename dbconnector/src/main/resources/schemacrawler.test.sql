...
CREATE TABLE INVOICE(ID INTEGER NOT NULL PRIMARY KEY,CUSTOMERID INTEGER,TOTAL FLOAT,CONSTRAINT SYS_FK_1 FOREIGN KEY(CUSTOMERID) REFERENCES CUSTOMER(ID));
CREATE TABLE SUPPLIER(SUPPLIER_ID INTEGER,SUPPLIER_NAME VARCHAR(255),CONSTRAINT CHECK_UPPERCASE_SUPPLIER_NAME CHECK(SUPPLIER_NAME=UPPER(SUPPLIER_NAME)));
...
CREATE INDEX SYS_USER_SYS_IDX_6_1 ON ITEM(INVOICEID);
CREATE INDEX SYS_USER_SYS_IDX_8_2 ON ITEM(PRODUCTID);
CREATE INDEX SYS_USER_SYS_IDX_2_9 ON INVOICE(CUSTOMERID);
ALTER TABLE ITEM ADD CONSTRAINT SYS_FK_4 FOREIGN KEY(INVOICEID) REFERENCES INVOICE(ID);
ALTER TABLE ITEM ADD CONSTRAINT SYS_FK_5 FOREIGN KEY(PRODUCTID) REFERENCES PRODUCT(ID);
