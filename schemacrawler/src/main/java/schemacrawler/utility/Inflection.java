...
/**
 * Implementation of Rails' <a href='http://api.rubyonrails.org/classes/ActiveSupport/CoreExtensions/String/Inflections.html'>In
 * f l e c t i o n s < / a > to handle singularization and pluralization
 * of 'Rails strings'. Copied from <a
