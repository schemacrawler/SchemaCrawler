  ...
  extends DependantObject
{
  ...
  /**
   * Gets the condition timing. BEFORE = the trigger is executed before the triggering data manipulation operation;
   * INSTEAD OF = the trigger is executed instead of the triggering data manipulation operation; AFTER = the trigger is
   * executed after the triggering data manipulation operation.
   *
