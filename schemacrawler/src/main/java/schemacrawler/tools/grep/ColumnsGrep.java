...
import schemacrawler.main.OptionsParser;
...
public final class ColumnsGrep
{
    ...
    throws Exception
  {
    ...
    final String includeColumns = OptionsParser.getStringOption(parser
