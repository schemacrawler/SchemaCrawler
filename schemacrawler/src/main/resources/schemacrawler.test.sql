...
-- Foreign keys
ALTER TABLE ITEM ADD CONSTRAINT FK_B_ITEM_INVOICE FOREIGN KEY(INVOICEID) REFERENCES INVOICE(ID);
ALTER TABLE ITEM ADD CONSTRAINT FK_A_ITEM_PRODUCT FOREIGN KEY(PRODUCTID) REFERENCES PRODUCT(ID);
