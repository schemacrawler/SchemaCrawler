...
import static schemacrawler.tools.command.text.schema.options.HideDependentDatabaseObjectsType.hideAlternateKeys;
import static schemacrawler.tools.command.text.schema.options.HideDependentDatabaseObjectsType.hideForeignKeys;
import static schemacrawler.tools.command.text.schema.options.HideDependentDatabaseObjectsType.hideIndexes;
import static schemacrawler.tools.command.text.schema.options.HideDependentDatabaseObjectsType.hidePrimaryKeys;
import static schemacrawler.tools.command.text.schema.options.HideDependentDatabaseObjectsType.hideRoutineParameters;
import static schemacrawler.tools.command.text.schema.options.HideDependentDatabaseObjectsType.hideTableColumns;
import static schemacrawler.tools.command.text.schema.options.HideDependentDatabaseObjectsType.hideTableConstraints;
import static schemacrawler.tools.command.text.schema.options.HideDependentDatabaseObjectsType.hideTriggers;
import static schemacrawler.tools.command.text.schema.options.HideDependentDatabaseObjectsType.hideWeakAssociations;
