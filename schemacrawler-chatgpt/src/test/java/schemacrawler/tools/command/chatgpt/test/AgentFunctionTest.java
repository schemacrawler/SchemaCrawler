...
public class AgentFunctionTest {

  @Test
  public void agent(final TestContext testContext) throws Exception {
    final NoFunctionParameters args = new NoFunctionParameters();
    final AgentFunctionDefinition functionDefinition = new AgentFunctionDefinition();
