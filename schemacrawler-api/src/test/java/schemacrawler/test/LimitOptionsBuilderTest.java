...
public class LimitOptionsBuilderTest
{
  ...
  public void routineTypes()
  {
    ...
    assertThat(limitOptions.getRoutineTypes(),
               containsInAnyOrder(function, procedure));
    limitOptionsPlayback = LimitOptionsBuilder
      .builder()
      .fromOptions(limitOptions)
      .toOptions();
    assertThat(limitOptionsPlayback.getRoutineTypes(),
               containsInAnyOrder(function, procedure));
  ...
  public void tableTypes()
  {
    ...
    limitOptionsPlayback = LimitOptionsBuilder
      ...
      .fromOptions(limitOptions)
      .toOptions();
    assertThat(limitOptionsPlayback
                 .getTableTypes()
                 .toArray(),
               is(new String[] { "TABLE", "VIEW", "BASE TABLE" }));
