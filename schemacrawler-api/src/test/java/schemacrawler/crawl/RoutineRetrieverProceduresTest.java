...
public class RoutineRetrieverProceduresTest
{
  ...
  public void proceduresFromDataDictionary(final TestContext testContext, final Connection connection)
    throws Exception
  {
    final InformationSchemaViews informationSchemaViews = InformationSchemaViewsBuilder
      .builder()
      .withSql(InformationSchemaKey.PROCEDURES, "SELECT * FROM INFORMATION_SCHEMA.SYSTEM_PROCEDURES")
      .toOptions();
    ...
    final RoutineRetriever procedureRetriever = new RoutineRetriever(retrieverConnection, catalog, options);
    procedureRetriever.retrieveProcedures(catalog.getAllSchemas(), new IncludeAll());

    final TestWriter testout = new TestWriter();
    try (final TestWriter out = testout)
    {
      final Routine[] procedures = ((Catalog) catalog)
        .getRoutines()
