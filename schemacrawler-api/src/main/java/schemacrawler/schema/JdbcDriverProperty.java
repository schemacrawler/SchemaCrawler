  ...
  extends Property
{
   ...
   * <code>DriverPropertyInfo.value</code> may be selected from a particular set
   * of values.
   *
   ...
   * information supplied to the method <code>getPropertyInfo</code>, the Java
   * environment, and the driver-supplied default values. This field may be null
