...
public final class MutableResultsColumns extends AbstractNamedObject implements ResultsColumns {
  ...
  public MutableResultsColumns(final String name) {
    super(name);
  }
  ...
  public void addColumn(final MutableResultsColumn column) {
    columns.add(column);
  }
}
