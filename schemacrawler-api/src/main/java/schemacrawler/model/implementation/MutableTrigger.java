...
public class MutableTrigger extends AbstractDependantObject<Table> implements Trigger {
  ...
  public MutableTrigger(final Table parent, final String name) {
  ...
  public void setEventManipulationTypes(final Set<EventManipulationType> eventManipulationTypes) {
