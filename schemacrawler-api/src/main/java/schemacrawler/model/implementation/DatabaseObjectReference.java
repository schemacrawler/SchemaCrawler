...
public class DatabaseObjectReference<D extends DatabaseObject> implements Serializable {
  ...
  public DatabaseObjectReference(final D databaseObject, final D partial) {
    databaseObjectRef =
