...
public final class MutableCatalog extends AbstractNamedObjectWithAttributes implements Catalog {
  ...
  public void addColumnDataType(final MutableColumnDataType columnDataType) {
    if (columnDataType != null) {
      columnDataTypes.add(columnDataType);
    }
  }

  public void addDatabaseUser(final ImmutableDatabaseUser databaseUser) {
    databaseUsers.add(databaseUser);
  }

  public void addRoutine(final MutableRoutine routine) {
    routines.add(routine);
  }
  ...
  public void addSequence(final MutableSequence sequence) {
    sequences.add(sequence);
  }

  public void addSynonym(final MutableSynonym synonym) {
    synonyms.add(synonym);
  }
