...
public final class MutableFunction extends MutableRoutine implements Function {
  ...
  public MutableFunction(final Schema schema, final String name, final String specificName) {
  ...
  public void addParameter(final MutableFunctionParameter column) {
    columns.add(column);
  }

  public void setReturnType(final FunctionReturnType returnType) {
