...
public class MutableKeyColumn extends AbstractDependantObject<Table> implements Column {
  ...
  public MutableKeyColumn(final Column column) {
  ...
  public void setKeyOrdinalPosition(final int keyOrdinalPosition) {
