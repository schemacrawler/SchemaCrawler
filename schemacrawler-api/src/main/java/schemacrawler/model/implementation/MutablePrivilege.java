...
public final class MutablePrivilege<D extends DatabaseObject> extends AbstractDependantObject<D>
  ...
  public MutablePrivilege(final DatabaseObjectReference<D> parent, final String name) {
    super(parent, name);
  ...
  public void addGrant(final String grantor, final String grantee, final boolean isGrantable) {
