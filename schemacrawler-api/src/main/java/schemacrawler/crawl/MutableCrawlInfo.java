...
final class MutableCrawlInfo implements CrawlInfo {
  ...
  public String toString() {
    final String crawlTimestampString =
        ISO_LOCAL_DATE_TIME.format(getCrawlTimestampUTC());
...
private ZonedDateTime getCrawlTimestampUTC(){return ZonedDateTime.ofInstant(crawlTimestamp, UTC);}
