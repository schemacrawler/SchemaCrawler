...
public class CommandLineParserTest
{
  ...
  public void badFormat()
  {
    ...
    assertTrue(!parser.getOption("size")
      .isFound());
  }
  ...
  public void resetBetweenParse()
  {
    ...
    assertTrue(!parser.getOption("verbose")
      .isFound());
  }
  ...
  public void standardOptions()
  {
    ...
    assertTrue(!parser.getOption("missing")
      .isFound());
    assertEquals(Boolean.TRUE, parser.getOption("verbose").getValue());
    assertEquals(100, ((Number) parser.getOption("size")
      .getValue()).intValue());
    assertEquals("foo", parser.getOption("name").getValue());
    assertEquals(0.1, ((Number) parser.getOption("fraction")
      .getValue())
      .doubleValue(), 0.1e-6);
  ...
  public void testCustomOption()
  {
    ...
    final Calendar d = (Calendar) parser.getOption("date")
      .getValue();
