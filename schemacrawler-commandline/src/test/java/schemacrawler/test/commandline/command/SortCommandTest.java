...
public class SortCommandTest {
  ...
  public void allArgs() {
    ...
    assertThat(builder.toOptions().isAlphabeticalSortForRoutineParameters(), is(true));
  }
  ...
  public void sortTablesFalse() {
    final String[] args = {"--sort-tables=false"};
  ...
  public void sortTablesTrue() {
    final String[] args = {"--sort-tables=true"};
    ...
    assertThat(builder.toOptions().isAlphabeticalSortForRoutineParameters(), is(false));
  }
}
