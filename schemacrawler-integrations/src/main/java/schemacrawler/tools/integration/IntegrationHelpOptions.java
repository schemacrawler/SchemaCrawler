  ...
  extends HelpOptions
{
  ...
  public IntegrationHelpOptions(final String title,
                                final String resourceOutputOptions)
  {
    super(title);
    setCommandHelpType(CommandHelpType.without_operations);
    setResourceOutputOptions(resourceOutputOptions);
  }
