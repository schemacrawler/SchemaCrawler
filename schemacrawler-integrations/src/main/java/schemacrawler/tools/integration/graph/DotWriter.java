...
final class DotWriter
{
                    ...
                    final JdbcDriverInfo jdbcDriverInfo)
  {
    ...
    graphInfo.append("          <td align=\"left\">").append(schemaCrawlerInfo
      ...
      .getSchemaCrawlerVersion()).append("</td>").append(NEWLINE);
    graphInfo.append("        </tr>").append(NEWLINE);
    ...
    graphInfo.append("          <td align=\"left\">").append(jdbcDriverInfo
      .getConnectionUrl()).append("</td>").append(NEWLINE);
    graphInfo.append("        </tr>").append(NEWLINE);
  ...
  public void print(final Table table)
  {
    ...
    buffer.append("  \"").append(tableName).append("\" [").append(NEWLINE)
    ...
    for (final Column column: table.getColumns())
    {
      ...
      buffer.append("          <td port=\"").append(columnName)
        ...
        .append(column.getWidth()).append("</td>").append(NEWLINE);
      buffer.append("        </tr>").append(NEWLINE);
    }
