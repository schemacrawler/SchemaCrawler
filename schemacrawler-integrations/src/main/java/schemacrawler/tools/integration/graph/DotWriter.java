...
final class DotWriter
{
                    ...
                    final JdbcDriverInfo jdbcDriverInfo)
  {
    ...
    graphInfo.append("          <td align=\"left\">")
      .append(schemaCrawlerInfo.getSchemaCrawlerProductName())
      .append(" ")
      .append(schemaCrawlerInfo.getSchemaCrawlerVersion())
      .append("</td>")
      .append(NEWLINE);
    graphInfo.append("        </tr>")
      .append(NEWLINE);
    ...
    graphInfo.append("          <td align=\"right\">JDBC Connection:</td>")
      .append(NEWLINE);
    graphInfo.append("          <td align=\"left\">")
      .append(jdbcDriverInfo.getConnectionUrl())
      .append("</td>")
      .append(NEWLINE);
    graphInfo.append("        </tr>")
      .append(NEWLINE);
    ...
    graphInfo.append("          <td align=\"right\">JDBC Driver:</td>")
      .append(NEWLINE);
    graphInfo.append("          <td align=\"left\">")
      .append(jdbcDriverInfo.getDriverName())
      .append("  ")
      .append(jdbcDriverInfo.getDriverVersion())
      .append("</td>")
      .append(NEWLINE);
    graphInfo.append("        </tr>")
      .append(NEWLINE);
  ...
  public void print(final Table table)
  {
    ...
    buffer.append("          <td bgcolor=\"")
      .append(tableBgColor)
      .append("\" align=\"right\">")
      .append((table instanceof View ? "[view]" : "[table]"))
      .append("</td>")
      .append(NEWLINE);
    buffer.append("        </tr>")
      .append(NEWLINE);
    for (final Column column : table.getColumns())
    {
      ...
      buffer.append("        <tr>")
        .append(NEWLINE);
      buffer.append("          <td port=\"")
        .append(columnName)
        .append(".start\" bgcolor=\"")
        .append(columnBgcolor)
        .append("\" align=\"left\">")
        .append(columnName)
        .append("</td>")
        .append(NEWLINE);
      ...
      buffer.append("          <td port=\"")
        .append(columnName)
        .append(".end\" align=\"right\" bgcolor=\"")
        .append(columnBgcolor)
        .append("\">")
        .append(column.getType().getDatabaseSpecificTypeName())
