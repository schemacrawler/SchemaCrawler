SELECT /*+ PARALLEL(AUTO) */
    ...
    TABLES.IOT_TYPE,
    TABLES.IOT_NAME
FROM ${catalogscope}_TABLES TABLES
...
WHERE TABLES.OWNER NOT IN
      ('ANONYMOUS', 'APEX_PUBLIC_USER', 'APPQOSSYS', 'BI', 'CTXSYS', 'DBSNMP',
       'DIP',
       'EXFSYS', 'FLOWS_30000', 'FLOWS_FILES', 'GSMADMIN_INTERNAL', 'IX',
       'LBACSYS',
  ...
  AND NOT REGEXP_LIKE(TABLES.TABLE_NAME,
                      '^(SYS_IOT|MDOS|MDRS|MDRT|MDOT|MDXT)_.*$')
